...
To further compliment our previous analysis with the Choropleth Map (shortest distance), we have used the Voronoi to identify difference between the **flying distance to validate our** Choropleth map analysis of the number of residential building serviced before and after the closure of the primary schools. We will now look into each of them shortly.
